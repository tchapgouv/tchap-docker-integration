...
ENDPOINT="${BASE_URL}/_matrix/identity/api/v1/internal-info"
...
AGENT='{"hs":"tchapgouv.com","requires_invite":false,"invited":false}'
INVITED='{"hs":"tchapgouv.com","requires_invite":true,"invited":true}'
NOT_INVITED='{"hs":"tchapgouv.com","requires_invite":true,"invited":false}'
FALLBACK='{"hs":"wrong.server.com","requires_invite":false,"invited":false}'

# --- Tests : domaines agents ----------------------------------------------------

expect_body "agent tchapgouv.com               -> hs=tchapgouv.com, invited=false" \
  "${ENDPOINT}?medium=email&address=user%40tchapgouv.com" "$AGENT"
